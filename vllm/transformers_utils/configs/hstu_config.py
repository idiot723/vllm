...
class RankingConfig(BaseTaskConfig):
    ...
    embedding_stack_seq_cnt: Optional[List[int]] = None
    embedding_feature_cnt: Optional[List[int]] = None
...
class InferenceHSTUConfig:
    ...
    max_preprocess_len: Optional[int] = 1000
...
def get_inference_hstu_config(
    ...
    return InferenceHSTUConfig(  # type: ignore
        ...
        rab=rab,
        max_preprocess_len=max_preprocess_len,
    )
...
class HSTUInferenceRankingConfig(PretrainedConfig):
    ...
    hidden_size: int
    vocab_size: int
    merged_table: Optional[bool]
    input_seq: Optional[List[str]]
    infer_ratings_key: Optional[str]
    infer_items_key: Optional[str]
    num_ratings: Optional[int]
    multi_value_prefix: Optional[str]
    features_cnt: Optional[int]
    model_module_mapping: Optional[Dict[str, str]]
    ...
    def __init__(self,
                 ...
                 merged_table: Optional[bool] = None,
                 input_seq: Optional[List[str]] = None,
                 infer_ratings_key: Optional[str] = None,
                 infer_items_key: Optional[str] = None,
                 num_ratings: Optional[int] = None,
                 multi_value_prefix: Optional[str] = None,
                 features_cnt: Optional[int] = None,
